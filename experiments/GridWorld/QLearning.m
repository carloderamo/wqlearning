...
for experiment = 1:n_experiments
    ...
    current_state = start;
    n_lambda = zeros(n_states, n_actions);
    ...
    for i = 1:n_steps
        ...
        n_lambda(current_state, action) = n_lambda(current_state, action) + 1;
        ...
        Q(current_state, action) = Q(current_state, action) + (1 / n_lambda(current_state, action)^exp) * delta;
