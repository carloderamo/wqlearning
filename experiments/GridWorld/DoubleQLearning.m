...
parfor experiment = 1:n_experiments
    ...
    current_state = start;
    n_lambda = zeros(n_states, n_actions, 2);
    ...
    for i = 1:n_steps
        ...
        n_lambda(current_state, action, which_Q(experiment, i)) = n_lambda(current_state, action, which_Q(experiment, i)) + 1;
        ...
        Q(current_state, action, which_Q(experiment, i)) = Q(current_state, action, which_Q(experiment, i)) ...
            + (1 / n_lambda(current_state, action, which_Q(experiment, i))^exp) * delta;
