...
figure
[max_Q3, r3] = BiasCorrectedQLearning(n_states, n_actions, n_experiments, start, goal, n_cols, n_steps, gamma, exp, reward_array, policy);
plot(mean(max_Q3));
figure
plot(mean(r3));
...
save(strcat('/home/shirokuma/Desktop/','grid-exp', exp_text, reward_type_text, policy_text, '.mat'), 'r1', 'r2', 'r3', 'max_Q1', 'max_Q2', 'max_Q3');
